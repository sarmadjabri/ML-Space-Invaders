...
class SpaceInvadersEnv:
    ...
    def render(self):
        """Render the current game screen using pygame."""
        # Note: Ensure that the game is loaded properly; Stella should power the game behind the scenes.
    ...
    def step(self, action):
        ...
        if fired_shot:
            ...
            # Else: during the loading period, do not penalize a "missed" shot.
